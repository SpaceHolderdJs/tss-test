import { c as createRouter, a as createRootRoute, b as createFileRoute, l as lazyRouteComponent, u as useRouterState, H as HeadContent, S as Scripts, L as Link } from "../_libs/tanstack__react-router.mjs";
...
const appCss = "/assets/styles-BA7hX5Dc.css";
...
function RootDocument({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "en", suppressHydrationWarning: true, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "body",
      {
        className: `font-sans antialiased [overflow-wrap:anywhere] selection:bg-[rgba(79,184,178,0.24)] ${showSiteChrome ? "" : "bg-[#FFFFFF]"}`,
        children: [
          showSiteChrome ? /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}) : null,
          children,
          showSiteChrome ? /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {}) : null,
...
const $$splitErrorComponentImporter = () => import("./users-DO7phkYD.mjs");
const $$splitComponentImporter$2 = () => import("./users-DxG6XMuB.mjs");
const Route$2 = createFileRoute("/users")({
...
const $$splitComponentImporter = () => import("./index-DiVDkObK.mjs");
const Route = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component"),
  ssr: true
});
const UsersRoute = Route$2.update({
  id: "/users",
  path: "/users",
