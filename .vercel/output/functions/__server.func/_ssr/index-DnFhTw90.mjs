...
import { H as Heart, S as ShoppingBag, M as Menu, X, C as ChevronLeft, a as ChevronRight, T as Twitter, F as Facebook, Y as Youtube, I as Instagram } from "../_libs/lucide-react.mjs";
...
function NikeCarouselNav({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-end gap-2 sm:gap-[12.375px]", children: [
...
function WideImageStory({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto mt-8 w-full max-w-[1008px] px-2 text-center sm:mt-12 sm:px-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-6 max-w-[531px] px-2 text-[15px] font-normal leading-relaxed text-[#111111] sm:px-4 sm:leading-[1.6]", children: description }),
...
function NikeFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-[#111111] text-[#FFFFFF]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1440px] px-4 pb-10 pt-10 sm:px-[34px]", children: [
...
function NikeLanding() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#FFFFFF] font-['Helvetica_Neue',Helvetica,Arial,sans-serif] text-[#111111] antialiased", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "relative z-20 bg-[#FFFFFF] [&_a]:!text-[#111111] [&_a]:no-underline hover:[&_a]:opacity-70", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto hidden h-9 max-w-[1440px] items-center justify-between px-6 lg:flex lg:px-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(NikeMark, { className: "size-6 shrink-0 text-[#111111]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-[15.375px] py-2.5 pl-3 pr-[6.125px] text-[11px] font-medium leading-[1.273]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", children: "Find a Store" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-9 items-center justify-center gap-3 px-2 text-[11px] font-medium leading-[1.273]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", children: "Join Us" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-normal leading-[1.167]", children: "|" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", children: "Sign In" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto flex min-h-14 max-w-[1440px] items-center justify-between gap-3 px-4 py-2 lg:h-[60px] lg:px-12 lg:py-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(NikeMark, { className: "size-6 shrink-0 text-[#111111] lg:hidden" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "nav",
          {
            ...
            "aria-label": "Primary",
            children: PRIMARY_NAV.map(({ href, label, className: linkCls }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex shrink-0 items-center gap-1 sm:gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5 sm:gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
      ...
      mobileNavOpen ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-[#E5E5E5] px-4 py-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[15px] font-medium", children: "Menu" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    ...
                    onClick: () => setMobileNavOpen(false),
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "size-6", strokeWidth: 1.5 })
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto border-t border-[#E5E5E5] px-4 py-4 text-[11px] font-medium leading-relaxed", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", onClick: () => setMobileNavOpen(false), children: "Find a Store" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", onClick: () => setMobileNavOpen(false), children: "Help" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", onClick: () => setMobileNavOpen(false), children: "Join Us" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", onClick: () => setMobileNavOpen(false), children: "Sign In" })
              ] }) })
            ]
          }
        )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-[15px] font-medium leading-snug text-[#111111]", children: "Hello Nike App" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-0.5 max-w-md px-2 text-center text-[11px] font-normal leading-relaxed text-[#111111]", children: "Download the app to access everything Nike. Get Your Great" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "main",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto w-full max-w-[1344px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative aspect-[1344/700] w-full min-h-[200px] overflow-hidden bg-[#F5F5F5] sm:min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: IMG.hero,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto mt-8 w-full max-w-[1008px] px-1 text-center sm:mt-12 sm:px-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] font-medium leading-[1.6] text-[#111111]", children: "First Look" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-1 text-3xl font-medium uppercase leading-[1.08] tracking-normal text-[#111111] sm:text-4xl md:text-5xl lg:text-[56px] lg:leading-[1.071]", children: "Nike Air Max Pulse" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-6 max-w-[512px] px-1 text-[15px] font-normal leading-relaxed text-[#111111] sm:mt-7 sm:px-4 lg:max-w-none lg:px-[248px] lg:leading-[1.6]", children: "Extreme comfort. Hyper durable. Max volume. Introducing the Air Max Pulse —designed to push you past your limits and help you go to the max." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto mt-[84px] w-full max-w-[1344px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Carousel, { opts: { align: "start", containScroll: "trimSnaps" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex min-h-[52px] flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:pr-[7px]", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto mt-[84px] w-full max-w-[1356px] pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Carousel, { opts: { align: "start", containScroll: "trimSnaps" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-[25px] flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4", children: [
